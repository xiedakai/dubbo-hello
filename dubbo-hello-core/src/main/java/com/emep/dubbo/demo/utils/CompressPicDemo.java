...
public class CompressPicDemo {
	...
	public static void main(String[] arg) {
		...
		for (int i = 0; i < 1; i++) {
			...
			mypic.compressPic("C:\\", "d:\\", "示例图片_01.jpg", "rt" + i + ".gif",
					1400, 1400, true);
	...
	public static File zoomPicture(File inputFile, String outputPicName,
			double max) {
		...
		try {
			...
			Double size1 = Math.floor(size / 1000);
			// 图片大小大于500kb时进行压缩 89100
			if (size1 > 500) {
				...
				littleFile = new File(outputPicName);
